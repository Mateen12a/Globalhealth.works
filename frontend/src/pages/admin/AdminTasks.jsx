...
import { Search, ExternalLink, CheckCircle, XCircle, Trash2, Loader2, Eye } from "lucide-react";
...
export default function AdminTasks() {
  ...
  const StatusBadge = ({ status }) => {
    const config = {
      published: { color: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400", icon: CheckCircle },
      withdrawn: { color: "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400", icon: XCircle },
      draft: { color: "bg-[var(--color-bg-tertiary)] text-[var(--color-text-secondary)]", icon: null },
